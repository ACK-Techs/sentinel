...
| Dosya | Rol |
|-------|-----|
| `IMPLEMENTATION_PLAN_PHASE4.md` | Tam plan (mock + gerçek yığın doğrulaması) |
| `CODEX_EXECUTION_PROMPT_PHASE4.md` | Tek mesajda Codex yürütme |
...
**Cursor yürütücü skill (kod ajanı):** `.cursor/skills/sentinel-phase4-executor/SKILL.md` — bu repoda Faz 4 kodunu yazan ajan önce bunu okusun.
