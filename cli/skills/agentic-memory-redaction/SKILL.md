...
## Bellek davranışı
`agentic-memory-redaction` için temel ilke: bellek yazımı "yardımcı" ama "güvenli" olmalıdır. Sentinel’de extract, away summary, magic docs ve dreaming adımları tur sonu pipeline içinde birlikte çalışır; biri bozulduğunda diğerleri sessizce veri kirletmemelidir.
...
- Redaction kurallarina JWT, PEM, bearer token, API key regexlerini ekle. Maskelenen alanin uzunlugunu degistirmeden kismi koru.
