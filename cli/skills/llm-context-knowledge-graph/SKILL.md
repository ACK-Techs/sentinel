---
name: llm-context-knowledge-graph
...
## Problem çerçevesi
`llm-context-knowledge-graph` başlığı, "model ne biliyor" sorusundan çok "modelin doğru anda doğru bağlamı görmesi" sorununu çözer. Yanlış bağlam yönetimi, iyi promptu bile etkisiz hale getirir.
...
- Knowledge graph kullanirken dugum-tiplerini (servis, alarm, owner, runbook) netlestir. Yanit uretirken graph pathi kaynak gosterimi icin kullan.
