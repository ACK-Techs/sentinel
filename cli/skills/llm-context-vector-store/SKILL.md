...
## Problem çerçevesi
`llm-context-vector-store` başlığı, "model ne biliyor" sorusundan çok "modelin doğru anda doğru bağlamı görmesi" sorununu çözer. Yanlış bağlam yönetimi, iyi promptu bile etkisiz hale getirir.
...
- Vector store seciminde sadece hiz degil silme, TTL ve metadata filtre kabiliyetini de degerlendir. Embedding modeli degisince yeniden index planla.

## Referanslar
- `references/vector-store-selection-playbook.md`
