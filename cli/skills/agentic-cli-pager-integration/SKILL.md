---
name: agentic-cli-pager-integration
...
## Ürün davranışı
`agentic-cli-pager-integration`, CLI yüzeyinde kullanıcı deneyimi ile işletim güvenilirliğini birlikte ele alır. Hedef: hatada bile anlaşılır çıkan, otomasyonda stabil çalışan ve etkileşimli kullanımda operatörü yormayan bir komut hattı.
...
- Pager entegrasyonunda cikti uzunlugu esigini olcerek otomatik less ac. Renkli ciktiyi pagerda bozmamak icin uygun env bayraklarini ayarla.
