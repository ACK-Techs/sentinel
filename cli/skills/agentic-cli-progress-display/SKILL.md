---
name: agentic-cli-progress-display
...
## Ürün davranışı
`agentic-cli-progress-display`, CLI yüzeyinde kullanıcı deneyimi ile işletim güvenilirliğini birlikte ele alır. Hedef: hatada bile anlaşılır çıkan, otomasyonda stabil çalışan ve etkileşimli kullanımda operatörü yormayan bir komut hattı.
...
- Progress displayde bilinmeyen sureli isler icin spinner, bilinenlerde progress bar kullan. CI non-tty modunda ilerleme satirlarini sadele.
