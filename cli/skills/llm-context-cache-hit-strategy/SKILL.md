---
name: llm-context-cache-hit-strategy
...
## Problem çerçevesi
`llm-context-cache-hit-strategy` başlığı, "model ne biliyor" sorusundan çok "modelin doğru anda doğru bağlamı görmesi" sorununu çözer. Yanlış bağlam yönetimi, iyi promptu bile etkisiz hale getirir.
...
- Cache hit icin promptun degismeyen kismini prefixte sabitle ve dinamik veriyi sona koy. Kucuk format degisikliklerinin cache kiracagini unutma.
