...
## MCP bağlamı
`agentic-mcp-sampling` için odak, Model Context Protocol bileşenlerini Sentinel agent döngüsüne öngörülebilir şekilde bağlamaktır. Burada hata çoğunlukla koddan değil; şema, transport veya auth sözleşmesindeki küçük uyumsuzluklardan çıkar.
...
- Sampling taleplerinde server tarafi policy ve maliyet siniri koy. Kullanici onayi gerektiren durumlari istemciye acik sinyal et.
