---
name: agentic-cli-accessibility
...
## Ürün davranışı
`agentic-cli-accessibility`, CLI yüzeyinde kullanıcı deneyimi ile işletim güvenilirliğini birlikte ele alır. Hedef: hatada bile anlaşılır çıkan, otomasyonda stabil çalışan ve etkileşimli kullanımda operatörü yormayan bir komut hattı.
...
- Erisilebilirlikte renk-disinda semantik isaretler kullan. Screen reader icin tablo yerine line-by-line alternatif cikti sagla.
