---
name: agentic-cli-plugin-system
...
## Ürün davranışı
`agentic-cli-plugin-system`, CLI yüzeyinde kullanıcı deneyimi ile işletim güvenilirliğini birlikte ele alır. Hedef: hatada bile anlaşılır çıkan, otomasyonda stabil çalışan ve etkileşimli kullanımda operatörü yormayan bir komut hattı.
...
- Plugin sisteminde ABI/API surum uyumu kontrolu yap. Guvenilmeyen plugin kaynaklarina imza veya allowlist kosulu koy.
