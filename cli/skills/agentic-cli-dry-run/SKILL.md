...
## Ürün davranışı
`agentic-cli-dry-run`, CLI yüzeyinde kullanıcı deneyimi ile işletim güvenilirliğini birlikte ele alır. Hedef: hatada bile anlaşılır çıkan, otomasyonda stabil çalışan ve etkileşimli kullanımda operatörü yormayan bir komut hattı.
