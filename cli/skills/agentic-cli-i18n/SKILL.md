...
## Ürün davranışı
`agentic-cli-i18n`, CLI yüzeyinde kullanıcı deneyimi ile işletim güvenilirliğini birlikte ele alır. Hedef: hatada bile anlaşılır çıkan, otomasyonda stabil çalışan ve etkileşimli kullanımda operatörü yormayan bir komut hattı.
...
- i18n katmaninda mesaj anahtarlari koddan ayrik dosyada tutulsun. Eksik ceviride kontrollu fallback dili belirle.
