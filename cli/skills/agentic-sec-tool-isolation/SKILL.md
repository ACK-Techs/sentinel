---
name: agentic-sec-tool-isolation
...
## Güvenlik amacı
`agentic-sec-tool-isolation`, agentin çalışma serbestliğini daraltıp zarar ihtimalini azaltmak için tasarlanır. Güvenlik kontrolü yalnızca "engelle" yaklaşımı değildir; denetlenebilir log, açık hata mesajı ve sürdürülebilir operasyon da gerektirir.
...
- Tool isolationda her araci ayrik izin setiyle calistir. Dosya sistemi ve network yetkilerini minimum privilege ile dagit.
