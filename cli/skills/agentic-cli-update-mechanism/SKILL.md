---
name: agentic-cli-update-mechanism
...
## Ürün davranışı
`agentic-cli-update-mechanism`, CLI yüzeyinde kullanıcı deneyimi ile işletim güvenilirliğini birlikte ele alır. Hedef: hatada bile anlaşılır çıkan, otomasyonda stabil çalışan ve etkileşimli kullanımda operatörü yormayan bir komut hattı.
...
- Update mekanizmasinda surum kontrolunu asenkron yap ve komut acilisini yavaslatma. Indirilen paketin hash/dijital imzasini dogrula.
