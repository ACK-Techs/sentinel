...
## Ürün davranışı
`agentic-cli-crash-report`, CLI yüzeyinde kullanıcı deneyimi ile işletim güvenilirliğini birlikte ele alır. Hedef: hatada bile anlaşılır çıkan, otomasyonda stabil çalışan ve etkileşimli kullanımda operatörü yormayan bir komut hattı.
...
- Crash reportte stack trace ile birlikte anonim ortam ozeti ekle. Kisisel veri ve tokenlari rapora girmeden once temizle.
