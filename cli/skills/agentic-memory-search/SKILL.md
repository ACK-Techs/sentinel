...
## Bellek davranışı
`agentic-memory-search` için temel ilke: bellek yazımı "yardımcı" ama "güvenli" olmalıdır. Sentinel’de extract, away summary, magic docs ve dreaming adımları tur sonu pipeline içinde birlikte çalışır; biri bozulduğunda diğerleri sessizce veri kirletmemelidir.
...
- Memory searchte tam metin + metadata filtreyi birlestir. Sonuclari tarih, guven ve proje iliskisine gore sirala.
