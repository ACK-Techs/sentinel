...
## Problem çerçevesi
`llm-context-conversation-history` başlığı, "model ne biliyor" sorusundan çok "modelin doğru anda doğru bağlamı görmesi" sorununu çözer. Yanlış bağlam yönetimi, iyi promptu bile etkisiz hale getirir.
...
- Konusma gecmisi yonetiminde "acik issue" ve "cozuldu" durum etiketleri kullan. Eski turdan tasinan varsayimlari belirli aralikta yeniden dogrulat.
