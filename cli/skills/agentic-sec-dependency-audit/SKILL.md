---
name: agentic-sec-dependency-audit
...
## Güvenlik amacı
`agentic-sec-dependency-audit`, agentin çalışma serbestliğini daraltıp zarar ihtimalini azaltmak için tasarlanır. Güvenlik kontrolü yalnızca "engelle" yaklaşımı değildir; denetlenebilir log, açık hata mesajı ve sürdürülebilir operasyon da gerektirir.
...
- Dependency auditte hem runtime hem dev bagimliliklarini tara. Kritik CVE icin merge blokaji, orta seviye icin SLA tanimla.
