...
## Problem çerçevesi
`llm-context-semantic-compaction` başlığı, "model ne biliyor" sorusundan çok "modelin doğru anda doğru bağlamı görmesi" sorununu çözer. Yanlış bağlam yönetimi, iyi promptu bile etkisiz hale getirir.
