---
name: agentic-sec-container-sandbox
...
## Güvenlik amacı
`agentic-sec-container-sandbox`, agentin çalışma serbestliğini daraltıp zarar ihtimalini azaltmak için tasarlanır. Güvenlik kontrolü yalnızca "engelle" yaklaşımı değildir; denetlenebilir log, açık hata mesajı ve sürdürülebilir operasyon da gerektirir.
...
- Container sandbox icinde seccomp, readonly fs ve network egress kisitlarini birlikte uygula. Privileged mode acikse guvenlik kazanimi kaybolur.
