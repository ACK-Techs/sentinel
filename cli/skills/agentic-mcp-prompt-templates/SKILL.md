---
name: agentic-mcp-prompt-templates
...
## MCP bağlamı
`agentic-mcp-prompt-templates` için odak, Model Context Protocol bileşenlerini Sentinel agent döngüsüne öngörülebilir şekilde bağlamaktır. Burada hata çoğunlukla koddan değil; şema, transport veya auth sözleşmesindeki küçük uyumsuzluklardan çıkar.
...
- Prompt template taniminda required argumentlari acik sec. Template ciktilari farkli model saglayicilarinda ayni niyeti korumali.
