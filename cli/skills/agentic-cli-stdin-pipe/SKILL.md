...
## Ürün davranışı
`agentic-cli-stdin-pipe`, CLI yüzeyinde kullanıcı deneyimi ile işletim güvenilirliğini birlikte ele alır. Hedef: hatada bile anlaşılır çıkan, otomasyonda stabil çalışan ve etkileşimli kullanımda operatörü yormayan bir komut hattı.
...
- stdin pipe akisinda komutun interaktif prompta gecmesini engelle. Bos stdin geldiyse kullaniciya net kullanim mesaji ver.
