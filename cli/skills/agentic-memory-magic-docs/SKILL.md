---
name: agentic-memory-magic-docs
...
## Bellek davranışı
`agentic-memory-magic-docs` için temel ilke: bellek yazımı "yardımcı" ama "güvenli" olmalıdır. Sentinel’de extract, away summary, magic docs ve dreaming adımları tur sonu pipeline içinde birlikte çalışır; biri bozulduğunda diğerleri sessizce veri kirletmemelidir.
...
- Magic docs guncellemesi yalniz marker blogunu degistirmeli, manuel icerige dokunmamali. Kok dizin taramasinda max dosya limiti koy.
