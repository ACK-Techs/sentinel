---
name: agentic-sec-webhook-signature
...
## Güvenlik amacı
`agentic-sec-webhook-signature`, agentin çalışma serbestliğini daraltıp zarar ihtimalini azaltmak için tasarlanır. Güvenlik kontrolü yalnızca "engelle" yaklaşımı değildir; denetlenebilir log, açık hata mesajı ve sürdürülebilir operasyon da gerektirir.
...
- Webhook signature dogrulamada timestamp toleransi ve replay cache kullan. Imza hatasinda 4xx don, detayli hata metni verme.
