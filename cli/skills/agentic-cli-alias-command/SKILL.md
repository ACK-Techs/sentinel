---
name: agentic-cli-alias-command
...
## Ürün davranışı
`agentic-cli-alias-command`, CLI yüzeyinde kullanıcı deneyimi ile işletim güvenilirliğini birlikte ele alır. Hedef: hatada bile anlaşılır çıkan, otomasyonda stabil çalışan ve etkileşimli kullanımda operatörü yormayan bir komut hattı.
...
- Alias komutlarda recursive alias dongusunu engelle. Alias cozumlemesi sonrasi gercek komutu --dry-run ile gosterebil.
