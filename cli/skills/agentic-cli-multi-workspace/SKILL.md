---
name: agentic-cli-multi-workspace
...
## Ürün davranışı
`agentic-cli-multi-workspace`, CLI yüzeyinde kullanıcı deneyimi ile işletim güvenilirliğini birlikte ele alır. Hedef: hatada bile anlaşılır çıkan, otomasyonda stabil çalışan ve etkileşimli kullanımda operatörü yormayan bir komut hattı.
...
- Multi-workspace modunda aktif workspace’i promptta gorunur kil. Workspace gecisinde profile, memory ve cache alanlarini ayri tut.
