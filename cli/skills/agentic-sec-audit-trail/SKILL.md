...
## Güvenlik amacı
`agentic-sec-audit-trail`, agentin çalışma serbestliğini daraltıp zarar ihtimalini azaltmak için tasarlanır. Güvenlik kontrolü yalnızca "engelle" yaklaşımı değildir; denetlenebilir log, açık hata mesajı ve sürdürülebilir operasyon da gerektirir.
...
- Audit trailde kim-ne-zaman-neyi-calistirdi bilgisi zorunlu olsun. Olay zincirini takip etmek icin correlation id kullan.
