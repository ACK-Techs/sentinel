---
name: llm-context-long-doc-processing
...
## Problem çerçevesi
`llm-context-long-doc-processing` başlığı, "model ne biliyor" sorusundan çok "modelin doğru anda doğru bağlamı görmesi" sorununu çözer. Yanlış bağlam yönetimi, iyi promptu bile etkisiz hale getirir.
...
- Uzun dokuman islerken bolumler arasi baglam kopusunu onlemek icin global index cikar. Ara ozetleri kaynaga bagli id ile sakla.
