---
name: agentic-memory-write-jail
...
## Bellek davranışı
`agentic-memory-write-jail` için temel ilke: bellek yazımı "yardımcı" ama "güvenli" olmalıdır. Sentinel’de extract, away summary, magic docs ve dreaming adımları tur sonu pipeline içinde birlikte çalışır; biri bozulduğunda diğerleri sessizce veri kirletmemelidir.
...
- Write jail acikken write_file araci kok disina cikmamali. Symlink ve path traversal kontrollerini explicit test et.
