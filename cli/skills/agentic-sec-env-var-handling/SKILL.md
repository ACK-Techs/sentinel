---
name: agentic-sec-env-var-handling
...
## Güvenlik amacı
`agentic-sec-env-var-handling`, agentin çalışma serbestliğini daraltıp zarar ihtimalini azaltmak için tasarlanır. Güvenlik kontrolü yalnızca "engelle" yaklaşımı değildir; denetlenebilir log, açık hata mesajı ve sürdürülebilir operasyon da gerektirir.
...
- Env var handlingde whitelist disi degiskenleri modele tasima. Debug ciktilarinda env degerlerini degil sadece anahtar adlarini goster.
