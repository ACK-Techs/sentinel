---
name: agentic-sec-jailbreak-resistance
...
## Güvenlik amacı
`agentic-sec-jailbreak-resistance`, agentin çalışma serbestliğini daraltıp zarar ihtimalini azaltmak için tasarlanır. Güvenlik kontrolü yalnızca "engelle" yaklaşımı değildir; denetlenebilir log, açık hata mesajı ve sürdürülebilir operasyon da gerektirir.
...
- Jailbreak direncinde role confusion ve authority spoofing kaliplarini algila. Supheli durumda read-only moda otomatik dusme politikasi koy.
