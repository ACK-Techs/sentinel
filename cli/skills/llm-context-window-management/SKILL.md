...
## Problem çerçevesi
`llm-context-window-management` başlığı, "model ne biliyor" sorusundan çok "modelin doğru anda doğru bağlamı görmesi" sorununu çözer. Yanlış bağlam yönetimi, iyi promptu bile etkisiz hale getirir.
...
- Context window yonetiminde sabit prefix, kaydirilan history ve son tur mesajini ayri segmentle. Trim oldugunda kullaniciya hangi kisimlarin atildigini kisa bildir.
